...
file_name = "training_s21"  # Do not include the file extension
...
# Graph parameters
x_axis_label = "Class Assistance (Percent)"
y_axis_label = "Test Grade (Percent)"
title = "Student Test Grades vs Class Assistance"
x_axis_min = 0
x_axis_max = 100
y_axis_min = 0
y_axis_max = 100
...
x = [0.15, 0.25, 0.50,   # Series 1 x-coordinates
     0.50, 0.75, 0.90]  # Series 2 x-coordinates
x = [x_axis_min + xi * (x_axis_max - x_axis_min) for xi in x] # Scale them for the graph

y = [0.25, 0.75, 0.85,   # Series 1 y-coordinates
     0.50, 0.25, 0.60]  # Series 2 y-coordinates
...
color_on_series1 = (254/255, 0/255, 0/255) # Red
color_on_series2 = (253/255, 0/255, 0/255) # Slight Red (non-distinguishable to the human eye)
