...
file_name = "trial_1_s21"  # Do not include the file extension
...
# Graph parameters
x_axis_label = "Movie Budget (Millions)"
y_axis_label = "Box Office Revenue (Millions)"
title = "Box Office Revenue vs Movie Budget for Three Genres"
x_axis_min = 0
x_axis_max = 100
y_axis_min = 0
y_axis_max = 100
...
color_on_series3 = (252/255, 0/255, 0/255) # Slighter Red (non-distinguishable to the human eye)
