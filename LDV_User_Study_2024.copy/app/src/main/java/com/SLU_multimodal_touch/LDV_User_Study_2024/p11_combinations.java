...
public class p11_combinations extends AppCompatActivity {
    ...
    // counter variable to track current trial
    int currentSeries = 1;
    ...
    final String graph_title = "Graph Title: Players' Assists vs Goals for Three Teams. "; // Title of the graph
    final String graph_x_axis_title = "X Axis Title: Goals. "; // Title of the X axis
    final String graph_y_axis_title = "Y Axis Title: Assists. "; // Title of the Y axis
        ...
        sfg.setOnFingerGestureListener(new SimpleFingerGestures_Mod.OnFingerGestureListener() {
            ...
            public boolean onSwipeUp(int fingers, long gestureDuration, double gestureDistance) {
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(p11_combinations.this, GraphSelector.class);
                ...
                if (fingers == 1) {
                    ...
                    switch (currentSeries){
                        case 1:
                            ...
                            break;
                        case 2:
                            mv.setImageResource(R.drawable.trial_1_p11);
                            TAG_trial = "1";
                            coord_view.setText(TAG_trial);
                            break;
                        case 3:
                            mv.setImageResource(R.drawable.trial_2_p11);
                            TAG_trial = "2";
                            coord_view.setText(TAG_trial);
                            break;
                        case 4:
                            mv.setImageResource(R.drawable.trial_3_p11);
                            TAG_trial = "3";
                            coord_view.setText(TAG_trial);
                            break;
                    }
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.HONEYCOMB_MR2) {
                    if (ContextCompat.checkSelfPermission(p11_combinations.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(p11_combinations.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                    }
                }
                else {
