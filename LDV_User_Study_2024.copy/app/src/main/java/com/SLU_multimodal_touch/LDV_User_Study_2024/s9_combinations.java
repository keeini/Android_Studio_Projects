...
public class s9_combinations extends AppCompatActivity {
    ...
    final String graph_title = "Graph Title: Sales vs Advertising Budget for Products of Three Companies. "; // Title of the graph
    final String graph_x_axis_title = "X Axis Title: Advertising Budget (Millions). "; // Title of the X axis
    final String graph_y_axis_title = "Y Axis Title: Sales (Millions). "; // Title of the Y axis
        ...
        sfg.setOnFingerGestureListener(new SimpleFingerGestures_Mod.OnFingerGestureListener() {
            ...
            public boolean onSwipeUp(int fingers, long gestureDuration, double gestureDistance) {
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(s9_combinations.this, GraphSelector.class);
                ...
                if (fingers == 1) {
                    ...
                    switch (currentSeries){
                        case 1:
                            ...
                            break;
                        case 2:
                            mv.setImageResource(R.drawable.trial_1_s9);
                            TAG_trial = "1";
                            coord_view.setText(TAG_trial);
                            break;
                        case 3:
                            mv.setImageResource(R.drawable.trial_2_s9);
                            TAG_trial = "2";
                            coord_view.setText(TAG_trial);
                            break;
                        case 4:
                            mv.setImageResource(R.drawable.trial_3_s9);
                            TAG_trial = "3";
                            coord_view.setText(TAG_trial);
                            break;
                    }
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.HONEYCOMB_MR2) {
                    if (ContextCompat.checkSelfPermission(s9_combinations.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(s9_combinations.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                    }
                }
                else {
