...
public class series_on_p11 extends AppCompatActivity {
    ...
    int series2_red = 0;
    int series2_green = 255;
    int series2_blue = 0;

    int series3_red = 0;
    int series3_green = 0;
    int series3_blue = 255;
    ...
    String TAG = "series_on_p11";
    String file_name;
    FileWriter writer;
    Boolean writer_active = true;

    private static final int RESULT_SPEECH = 1; // Request code for speech-to-text
    private TextView coord_view; // TextView to display recognized speech
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.series_on_p11);
        // Initiate the textView objects for the screen and for each finger
        coord_view = findViewById(R.id.coordinate_view);
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            // In landscape
            mv.setImageResource(R.drawable.series_1_on_p11);
        } else {
            // In portrait
            mv.setImageResource(R.drawable.series_1_on_p11);
        }
        ...
        sfg.setOnFingerGestureListener(new SimpleFingerGestures_Mod.OnFingerGestureListener() {
            ...
            public boolean onSwipeUp(int fingers, long gestureDuration, double gestureDistance) {
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(series_on_p11.this, GraphSelector.class);
            ...
            public boolean onSwipeLeft(int fingers, long gestureDuration, double gestureDistance) {
                if (fingers == 1) {
                    ...
                    switch (currentSeries){
                        case 1:
                            mv.setImageResource(R.drawable.series_1_on_p11);
                            coord_view.setText("series_1_on_p11");
                            break;
                        case 2:
                            mv.setImageResource(R.drawable.series_2_on_p11);
                            coord_view.setText("series_2_on_p11");
                            break;
                        case 3:
                            mv.setImageResource(R.drawable.series_3_on_p11);
                            coord_view.setText("series_3_on_p11");
                            break;
                    }
            ...
            public boolean onDoubleTap(int fingers) {
                // Trigger speech-to-text when double-tap is detected
                startSpeechToText();
                return true;
            }
        ...
        if (requestCode == RESULT_SPEECH) {
            if (resultCode == RESULT_OK && data != null) {
                ...
                if (text != null && !text.isEmpty()) {
                    // Safely retrieve and display the recognized text
                    String recognizedText = text.get(0);
                    if (coord_view != null) {
                        coord_view.setText(recognizedText); // Update the coordinate_view TextView
                    } else {
                        Toast.makeText(this, "Coordinate view is not initialized!", Toast.LENGTH_SHORT).show();
                    }
                } else {
                ...
                // Handle the case where speech recognition was canceled or failed
            ...
            public void run() {
                ...
                if (sfg.finger_count == 1){
                    ...
                    if (f0_index != -1) {
                        ...
                        // If finger is INSIDE the scatter 1
                        if (pixel_red == scatter1_red && pixel_green == scatter1_green && pixel_blue == scatter1_blue) {
                        ...
                        } else if(pixel_red == scatter2_red && pixel_green == scatter2_green && pixel_blue == scatter2_blue){
                            // Stop all other sounds
                            soundPool.stop(empty_sound_stream_id);
                            empty_sound_is_playing = false;
                        ...
                        } else if(pixel_red == scatter3_red && pixel_green == scatter3_green && pixel_blue == scatter3_blue){
                            // Stop all other sounds
                            soundPool.stop(empty_sound_stream_id);
                            empty_sound_is_playing = false;
                        ...
                        } else if(pixel_red == series1_red && pixel_green == series1_green && pixel_blue == series1_blue) {
                            // Stop all other sounds
                            soundPool.stop(empty_sound_stream_id);
                            empty_sound_is_playing = false;
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.HONEYCOMB_MR2) {
                    if (ContextCompat.checkSelfPermission(series_on_p11.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(series_on_p11.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                    }
                }
                else {
