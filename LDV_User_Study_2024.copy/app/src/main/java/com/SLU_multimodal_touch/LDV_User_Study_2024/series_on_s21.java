...
public class series_on_s21 extends AppCompatActivity {
    ...
    double vib_freq = 1;
    double vib_freq_two_five = 10; // Hz
    double vib_freq_ten = 20; // Hz
    double vib_freq_forever = 30; // Hz
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.series_on_s21);
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            // In landscape
            mv.setImageResource(R.drawable.series_1_on_s21);
        } else {
            // In portrait
            mv.setImageResource(R.drawable.series_1_on_s21);
        }
        ...
        sfg.setOnFingerGestureListener(new SimpleFingerGestures_Mod.OnFingerGestureListener() {
            ...
            public boolean onSwipeUp(int fingers, long gestureDuration, double gestureDistance) {
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(series_on_s21.this, GraphSelector.class);
            ...
            public boolean onSwipeLeft(int fingers, long gestureDuration, double gestureDistance) {
                if (fingers == 1) {
                    ...
                    switch (currentSeries){
                        case 1:
                            mv.setImageResource(R.drawable.series_1_on_s21);
                            coord_view.setText("series_1_on_s21");
                            break;
                        case 2:
                            mv.setImageResource(R.drawable.series_2_on_s21);
                            coord_view.setText("series_2_on_s21");
                            break;
                        case 3:
                            mv.setImageResource(R.drawable.series_3_on_s21);
                            coord_view.setText("series_3_on_s21");
                            break;
                    }
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.HONEYCOMB_MR2) {
                    if (ContextCompat.checkSelfPermission(series_on_s21.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(series_on_s21.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                    }
                }
                else {
