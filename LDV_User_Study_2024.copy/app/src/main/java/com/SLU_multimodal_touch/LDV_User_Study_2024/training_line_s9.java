...
public class training_line_s9 extends AppCompatActivity {
    ...
    final String graph_title = "Graph Title: Animal Population over Time"; // Title of the graph
    final String graph_x_axis_title = "X Axis Title: Year."; // Title of the X axis
    final String graph_y_axis_title = "Y Axis Title: Millions (Individuals)."; // Title of the Y axis
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mv.setImageResource(R.drawable.training_line_chart);
        ...
        sfg.setOnFingerGestureListener(new SimpleFingerGestures_Mod.OnFingerGestureListener() {
            ...
            public boolean onSwipeUp(int fingers, long gestureDuration, double gestureDistance) {
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(training_line_s9.this, GraphSelector.class);
...
//                            }
                            ...
                            if (!intersection_sound_is_playing) {
                                ...
                                tts.speak("Intersection: Animal 1, Animal 2.", TextToSpeech.QUEUE_FLUSH, null);
                            }
                        } else {
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.HONEYCOMB_MR2) { // DO NOT remove this "unnecessary" line, otherwise the app won't work on Lenovo tablets!
                    if (ContextCompat.checkSelfPermission(training_line_s9.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(training_line_s9.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                    }
                }
                else {
