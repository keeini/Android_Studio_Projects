...
public class training_scatter_s21 extends AppCompatActivity {
    ...
    final String graph_title = "Graph Title: Student Test Grades vs Class Assistance"; // Title of the graph
    final String graph_x_axis_title = "X Axis Title: Class Assistance (Percent)"; // Title of the X axis
    final String graph_y_axis_title = "Y Axis Title: Test Grade (Percent)"; // Title of the Y axis
    ...
    String TAG = "training_scatter_s21";
    String file_name;
    FileWriter writer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            // In landscape
            mv.setImageResource(R.drawable.training_scatter_s21);
        } else {
            // In portrait
            mv.setImageResource(R.drawable.training_scatter_s21);
        }
        ...
        sfg.setOnFingerGestureListener(new SimpleFingerGestures_Mod.OnFingerGestureListener() {
            ...
            public boolean onSwipeUp(int fingers, long gestureDuration, double gestureDistance) {
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(training_scatter_s21.this, GraphSelector.class);
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.HONEYCOMB_MR2) {
                    if (ContextCompat.checkSelfPermission(training_scatter_s21.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(training_scatter_s21.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                    }
                }
                else {
